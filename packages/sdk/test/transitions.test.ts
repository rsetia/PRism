...
const EVENTS: readonly RunEvent[] = [
  ...
  { kind: "node_agent_progress", nodeId: "n", state: "waiting" },
...
const LEGAL = new Map<string, NodeState>([
  ...
  ["running+node_usage_reported", "running"],
  ["cancelling+node_usage_reported", "cancelling"],
  ["running+node_agent_progress", "running"],
  ["cancelling+node_agent_progress", "cancelling"],
